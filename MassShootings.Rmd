---
title: "US Mass Shootings 2013 - 2015"
author: "Mike Piccirilli"
date: "October 4, 2015"
...
DT = DT[, nMonthYearVictims := sum(nVictims), by = monthYear]
DT = DT[, nVictimsPerState := sum(nVictims), by = State]
...
DT = DT[, nVictimsPerLocation := sum(nVictims), by = Location]
DT = DT[, nVictimsPerIncident := nVictimsPerLocation / LocationFreq]
